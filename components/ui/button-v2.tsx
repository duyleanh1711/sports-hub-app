...
export const buttonStyles = tv({
  base: [
    ...
    'relative isolate inline-flex items-center justify-center border border-(--btn-border) font-medium hover:no-underline cursor-pointer whitespace-nowrap transition-all duration-500',
  ...
  variants: {
    intent: {
      ...
      outline:
        'border-border bg-white [--btn-bg:transparent] [--btn-icon:var(--color-muted-fg)] [--btn-outline:var(--color-ring)] [--btn-overlay:var(--color-muted-fg)]/10 [--btn-ring:var(--color-ring)]/20',
      plain:
    ...
    size: {
      ...
      xl: [
        'min-h-10 gap-x-2 px-[calc(--spacing(3.5)-1px)] py-[calc(--spacing(3)-1px)] sm:min-h-10 sm:px-3 py-1 sm:py-[calc(--spacing(1.5)-1px)] sm:text-base',
        '*:data-[slot=icon]:size-5 sm:*:data-[slot=icon]:size-4.5',
        '*:data-[slot=loader]:size-5 sm:*:data-[slot=loader]:size-4.5',
      ],
      'sq-xs': [
